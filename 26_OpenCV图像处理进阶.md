...
昨天我们带领迈入了实战课程，学习了对Windows窗口的操作，模拟操作鼠标，也开始学习了解了OpenCV加载图像、显示图像和保存图像，今天在昨天OpenCV的学习基础上，带大家进一步的学识使用OpenCV，今天的课程内容丰富且精彩有趣，希望大家学的开心。
...
首先，在获取图像属性之前，我们需要加载图像，取得图像对象，通过图像对象的属性和函数我们就可以方便的查看图像的相关属性值了。今天的课程我们会以下面的示例图像（宽1080、高853的彩色图像）来带领大家学习使用OpenCV。
